...
function Register() {
  return (
    <section id='register' className="bg-white dark:bg-gray-900">
    <div className="py-8 px-2 mx-auto max-w-screen-xl sm:py-16 lg:px-2">
        <div className="mx-auto max-w-screen-sm text-center">
            ...
            <a href="#" className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Join the Waiting List</a>
        </div>
    </div>
</section>
  )
