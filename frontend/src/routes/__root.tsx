...
export const Route = createRootRoute({
  component: () => {
    return (
      <>
        <div className="px-10 flex gap-2 items-center justify-between h-14 max-w-screen-2xl fixed w-full top-0 left-0 bg-muted/40">
          ...
          <div className="flex items-start mx-4 gap-4">
          <div className="sm:flex sm:items-start sm:justify-between ">
            ...
            <Link to="#features" className="[&.active]:font-bold px-4">
             Features
            </Link>
            <Link to="#register" className="[&.active]:font-bold px-4">
              Register
            </Link>
          </div>
