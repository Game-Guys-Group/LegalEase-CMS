      ...
      <section id='features' className="bg-white dark:bg-gray-900">
        ...
        <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          ...
          <div className="mt-4 md:mt-0">
            ...
            <div className="pt-8">
              <a href="#" className="w-full px-8 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-8 focus:ring-blue-300 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started
