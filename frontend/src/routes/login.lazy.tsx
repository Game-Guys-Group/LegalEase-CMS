...
export function LoginForm() {
  ...
  return (
    <Card className="w-full p-2 mt-16 mx-auto max-w-lg rounded-none shadow-sm">
      <CardHeader>
      ...
      <CardContent>
        ...
        <div className="grid gap-4">
          ...
          <Button
            ...
            className="w-full inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center rounded-lg"
          >
            {isSubmitting ? (
